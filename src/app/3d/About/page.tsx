      ...
      >
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/3d/About" className="text-cyan-400 font-semibold">ABOUT</Link>
      ...
      <footer className="relative bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 max-w-md">
                Empowering organizations with comprehensive learning management solutions.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link href="/3d/About" className="hover:text-cyan-400 transition-colors">About</Link></li>
                <li><Link href="/3d/LogIn" className="hover:text-cyan-400 transition-colors">Login</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-white">Contact</h4>
              <ul className="space-y-2 text-gray-400">
                <li>Email: info@futureskills.com</li>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <div>© 2025 FutureSkills LMS. All rights reserved.</div>
          </div>
        </div>
      </footer>
    </main>
