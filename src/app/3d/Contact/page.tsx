  ...
  return (
    <div className="relative min-h-screen bg-linear-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
      ...
      <motion.nav 
        ...
        className="relative z-50 w-full px-6 py-4 bg-gray-900/95 backdrop-blur-sm shadow-lg"
      >
      ...
      {/* Footer */}
      <footer className="relative z-10 bg-black/40 backdrop-blur-md border-t border-white/10 text-white py-12 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-14 h-14 rounded-xl bg-linear-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-white font-bold text-2xl shadow-lg">
                FS
              </div>
              <div className="font-bold text-3xl">FutureSkills</div>
            </div>
            <p className="text-gray-300 mb-8 text-lg">
              Empowering learners worldwide with cutting-edge education
            </p>
            <div className="flex justify-center gap-8 mb-8">
              <Link href="/" className="hover:text-cyan-400 transition-colors font-semibold">Home</Link>
              <Link href="/3d/About" className="hover:text-cyan-400 transition-colors font-semibold">About</Link>
